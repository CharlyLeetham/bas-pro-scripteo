...
//				var_dump($result_count[0]); echo '<br>'; echo date('Y-m-d H:i:s', $time).'<br>';
	...
	// Add new Ad to DB
	public function addNewAd($id = NULL, $space_id, $ad_name = null, $buyer_email, $title, $description, $button, $url, $img, $html, $optional_field = null, $ad_model, $ad_limit, $capping, $cost, $paid, $status)
	{
		$this->addNewAdDB($id, $space_id, $ad_name, $buyer_email, $title, $description, $button, $url, $img, $html, $optional_field, $ad_model, $ad_limit, $capping, $cost, $paid, $status);
	}

	protected function addNewAdDB($id, $space_id, $ad_name, $buyer_email, $title, $description, $button, $url, $img, $html, $optional_field, $ad_model, $ad_limit, $capping, $cost, $paid, $status) {
		$this->wpdb->insert(

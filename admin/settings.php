...
?>
	...
	<form action="" method="post" novalidate>
		...
		<table class="bsaAdminTable bsaMarTopNull form-table">
			...
			<tr>
				<th scope="row"><label for="username">Affiliate - User ID</label></th>
				<td><input type="text" class="regular-text ltr" value="<?php validValue('username'); ?>" id="username" name="username">
					<p class="description">
						<strong>Paste your User ID to get more traffic via Affiliate Program</strong>
						<br>Referral Link will shown at the bottom of Ad Space. Each unique click = new user for your site. <strong>Current limit: up to 10 users per day.</strong> <a href="https://scripteo.info">Learn more</a>.
					</p>
				</td>
			</tr>
			<tr>
